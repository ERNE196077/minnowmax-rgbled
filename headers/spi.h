...
uint32_t __sitf__;
#define SPI_SSP_SITF_SITFL_READTXFIFOENTRIESSPI		(0x1FF << 16)
#define SPI_SSP_SITF_LWMTF_SETTXLOWWATERMARKSPI(value)	((value & 0xFF) << 8)
#define SPI_SSP_SITF_HWMTF_SETTXHIGHWATERMARKSPI(value)	(value & 0xFF)
uint32_t __sirf__;
#define SPI_SSP_SIRF_SIRFL_READRXFIFOENTRIESSPI			(0x1FF << 8)
#define SPI_SSP_SIRF_WMRF_SETRXFIFOWATERMARKSPI(value)	(value & 0xFF)
